...
class MatchReportInputAdmin(admin.ModelAdmin):
    list_display = ('report_name', 'adjective1', 'adjective2', 'old_saying', 'animals', 'fav_drink', 'sports_expression', 'golf_saying', 'lyric', 'group_noone_likes', 'recent_news', 'jobs', 'office_perk',)

# Register admin class
admin.site.register(MatchReportInput, MatchReportInputAdmin)

class TeamsRoundModelAdmin(admin.ModelAdmin):
    list_display = ('locator', 'team_name1', 'score1','team_name2', 'score2', 'team_name3', 'score3', 'team_name4', 'score4',)

admin.site.register(TeamsRoundModel, TeamsRoundModelAdmin)

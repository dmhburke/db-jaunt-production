...
class TeamsRoundModel(models.Model):
    locator = models.CharField(max_length=100, blank=True, null=True)
    #group 1 details
    team_name1 = models.CharField(max_length = 200, blank=True, null=True)
    holes1 = models.IntegerField(blank=True, null=True)
    score1 = models.IntegerField(blank=True, null=True)
    #group 2 details
    team_name2 = models.CharField(max_length = 200, blank=True, null=True)
    holes2 = models.IntegerField(blank=True, null=True)
    score2 = models.IntegerField(blank=True, null=True)
    #group 3 details
    team_name3 = models.CharField(max_length = 200, blank=True, null=True)
    holes3 = models.IntegerField(blank=True, null=True)
    score3 = models.IntegerField(blank=True, null=True)
    #group 4 details
    team_name4 = models.CharField(max_length = 200, blank=True, null=True)
    holes4 = models.IntegerField(blank=True, null=True)
...
class MatchReportInput(models.Model):
    report_name = models.ForeignKey('PlayerModel',on_delete = models.CASCADE)
    adjective1 = models.CharField(max_length=100, blank=True, null=True)
    adjective2 = models.CharField(max_length=100, blank=True, null=True)
    old_saying = models.CharField(max_length=200, blank=True, null=True)
    animals = models.CharField(max_length=100, blank=True, null=True)
    fav_drink = models.CharField(max_length=100, blank=True, null=True)
    sports_expression = models.CharField(max_length=200, blank=True, null=True)
    golf_saying = models.CharField(max_length=200, blank=True, null=True)
    lyric = models.CharField(max_length=200, blank=True, null=True)
    group_noone_likes = models.CharField(max_length=200, blank=True, null=True)
    recent_news = models.CharField(max_length=200, blank=True, null=True)
    jobs = models.CharField(max_length=200, blank=True, null=True)
    office_perk = models.CharField(max_length=200, blank=True, null=True)
